...
******* 记录日志
    ...
    DATA: lv_process_type TYPE zprocess_type VALUE 'ZFM_PP_CREATE_RESERVEORDER'.  "日志类型，记录SAP端 Function model name
...
*****log抬头
    ...
    ls_log_header-orderkey = input-mt_mes_reservation_order-is_header-transfernum."单据key
    ls_log_header-direction = 'RECEIVER'.  "SENDER
